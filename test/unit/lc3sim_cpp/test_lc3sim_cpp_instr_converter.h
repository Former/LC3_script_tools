...
TEST(BASE_NAME, RES1)
{
    REG_TYPE_FROM i_from = LC3_MAKE_INSTR_RES(6, 4, 2, 1, INSTR_BIT_COUNT_FROM, OPER_BIT_COUNT_FROM, REG_NUM_BIT_COUNT_FROM, PAR_BIT_COUNT_FROM);
    REG_TYPE_TO i_to = LC3_MAKE_INSTR_RES(6, 4, 2, 1, INSTR_BIT_COUNT_TO, OPER_BIT_COUNT_TO, REG_NUM_BIT_COUNT_TO, PAR_BIT_COUNT_TO);
...
TEST(BASE_NAME, RES2)
{
    REG_TYPE_FROM i_from = LC3_MAKE_INSTR_RES(0, 0, 0, 0, INSTR_BIT_COUNT_FROM, OPER_BIT_COUNT_FROM, REG_NUM_BIT_COUNT_FROM, PAR_BIT_COUNT_FROM);
    REG_TYPE_TO i_to = LC3_MAKE_INSTR_RES(0, 0, 0, 0, INSTR_BIT_COUNT_TO, OPER_BIT_COUNT_TO, REG_NUM_BIT_COUNT_TO, PAR_BIT_COUNT_TO);
