...
#define PARAM_AFTER_NUM2(instr)         LC3_PARAM_AFTER_NUM2(instr, INSTRUCTION_BIT_COUNT, OPER_CODE_BIT_COUNT, REG_NUM_BIT_COUNT, PARAM_BIT_COUNT)
#define UINT_AFTER_PARAM(instr)         LC3_UINT_AFTER_PARAM(instr, INSTRUCTION_BIT_COUNT, OPER_CODE_BIT_COUNT, REG_NUM_BIT_COUNT, PARAM_BIT_COUNT)
