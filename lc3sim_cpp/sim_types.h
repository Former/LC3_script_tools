...
#define BIT_COUNT(type) (sizeof(type) * BIT_IN_ONE_BYTE_COUNT)
    ...
    #define LC3_SWAP SWAP_32
    #define LC3_MAX_MEMORY_ADDRESS (2*UINT16_MAX) // may be up to UINT32_MAX
    #define LC3_INSTRUCTION_BIT_COUNT       (BIT_IN_ONE_BYTE_COUNT * sizeof(LC3_Sim::LC3_RegisterType))
...
#define LC3_SIGN_BIT_INDEX (sizeof(LC3_Sim::LC3_RegisterType) * BIT_IN_ONE_BYTE_COUNT - 1)
#define LC3_STATUS_BIT_INDEX (sizeof(LC3_Sim::LC3_RegisterType) * BIT_IN_ONE_BYTE_COUNT - 1)
